...
import {
  MapPin, Star, Search, Filter, ChevronRight, Shield,
  Clock, Package, TrendingDown, Zap, Map, List,
...
export function BuyerExplore() {
  ...
  const filteredShops = shops
    .filter(s => {
      ...
      const matchItemSearch = shopProducts.some(p => 
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-slate-900 mb-1" style={{ fontWeight: 800, fontSize: '1.7rem' }}>Explore Nearby Shops</h1>
          <p className="text-slate-500 flex items-center gap-1 text-sm">
            <MapPin className="w-4 h-4 text-orange-500" />
            Showing <span style={{ fontWeight: 600 }}>5 shops</span> within 5km of MP Nagar, Bhopal
          </p>
        </div>
